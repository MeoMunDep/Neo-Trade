...
> Help me with your referral [Link](https://neo.trade/invite?ref=1c0e5d74)
...
> To run the bot, use the following command: `cd "neo trade-main/neo trade"; node meomundep`
